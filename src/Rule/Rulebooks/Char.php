 ...
 */
class Char extends AbstractRulebook
{

    /**
     * Метод проверяет, является ли значение <b>$this->value</b> строкой с определенным кол-вом символов <b>$this->comparison_value</b><br>
    ...
    public function validate()
    {
        ...
        $this->codeResult = $isValidate ? Constant::IS_CHAR : Constant::NOT_CHAR;
        return $isValidate;
    }
}