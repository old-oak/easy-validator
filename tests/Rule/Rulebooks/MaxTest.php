...
{
    /**
     * @dataProvider additionProviderTestMax
     */
    public function testMax($value, $value2, $value3)
    {
        $obj = new \OldOak\EasyValidator\Validator(['test' => ["max:{$value2}"]], ['test' => $value]);
    ...
    public function additionProviderTestMax()
    {
        return [
            [15, -1, true],
            [15.5, -1, true],
